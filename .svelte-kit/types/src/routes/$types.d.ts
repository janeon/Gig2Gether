...
type LayoutRouteId = RouteId | "/" | "/(auth)/login" | "/(auth)/logout" | "/(auth)/register" | "/protected" | "/protected/(settings)/account" | "/protected/(settings)/demographics" | "/protected/(settings)/profile" | "/protected/settings" | null
