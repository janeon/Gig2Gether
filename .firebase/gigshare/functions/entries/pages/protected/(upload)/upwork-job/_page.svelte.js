...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let fileuploadprops = { id: "job_csv" };
  $$unsubscribe_page();
  return `  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css"> <div class="flex flex-row"><div class="w-1/4">${validate_component(UploadSidebar, "UploadSidebar").$$render($$result, {}, {}, {})}</div> <div class="w-3/4 rounded-md p-6"><p class="mb-3" data-svelte-h="svelte-1d34xwf">After screenshotting your completed job, add screenshots</p> <p data-svelte-h="svelte-nbtji3">Make sure the following are visible:</p> <ul class="max-w-md mx-auto space-y-1 list-disc list-inside" data-svelte-h="svelte-19g3jim"><li>Job start/end date</li> <li>Hourly Charge/ Fixed Price</li> <li>Hours Per Week</li> <li>Client History</li> <li>Job Category</li></ul> <p class="mt-4" data-svelte-h="svelte-kelqjq">Job information can be entered manually or via screenshot uploads.</p> <div class="flex justify-start mt-6"><div class="flex flex-col items-center space-y-4 ml-56"><label class="pb-2"${add_attribute("for", fileuploadprops.id, 0)}>Upload CSV</label> <input${add_attribute("id", fileuploadprops.id, 0)} type="file" accept=".csv" autocomplete="off" class="mt-1"> ${validate_component(Button, "Button").$$render(
    $$result,
    {
      class: "bg-black text-white rounded px-6 py-3",
      size: "xl",
      href: "/protected/upwork-job-screenshot"
    },
    {},
    {
      default: () => {
