...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const images = [
    ...
    {
      alt: "Uber Trip Screenshot example 2",
      src: "../trip2.jpg"
    },
    {
      alt: "Uber Trip Screenshot example 3",
      src: "../trip3.jpg"
    }
  ];
  $$unsubscribe_page();
  return `<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css"> <div class="flex flex-row"><div class="w-1/4">${validate_component(UploadSidebar, "UploadSidebar").$$render($$result, {}, {}, {})}</div> <div class="w-3/4 rounded-md p-6">${validate_component(Gallery, "Gallery").$$render($$result, { class: "gap-2 grid grid-cols-4" }, {}, {
    default: () => {
