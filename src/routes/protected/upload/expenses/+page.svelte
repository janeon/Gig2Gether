<script lang="ts">
	...
	const platformTooltips = {
		uber: 
			'Potential Tax-deductible expenditures can be found in Expenses, Fees, and Tax section on the Tax Information Tab of the Uber Driver Dashboard.',
		upwork:
	...
	<div class="py-2 flex flex-col items-center w-full">
		<div class="w-full max-w-md space-y-5">
			...
			<div class="flex flex-col">
				...
				<IconNumberInput bind:value={data.amount} className="mt-1" />
			</div>
		</div>
