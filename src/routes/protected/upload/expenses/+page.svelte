...
<div class="flex flex-row">
    <div class="py-2 flex flex-col items-center w-full">
        ...
        {#if $page.data.user?.platform == "uber"}
            <Button class="text-white bg-blue-400 mt-4">Reminder</Button>
            <Tooltip 
                type="custom" 
                defaultClass="" 
                class="p-4 text-sm font-medium bg-blue-500 text-gray-100" 
                arrow={false}>
                You can find your potential tax deductions through the Expenses, Fees, and Tax section on the Tax Information Tab of the Driver Dashboard.
            </Tooltip>
        {:else if $page.data.user?.platform == "upwork"}
            <Button class="text-white bg-blue-400 mt-4">Reminder</Button>
            <Tooltip 
                ...
                class="p-4 text-sm font-medium bg-blue-500 text-gray-100" 
                arrow={false}>
                You can track expenses related to your home office, utilities, phone and internet, office supplies, business travel, advertising, insurance, software, and other business-related costs to maximize tax deductions.
            </Tooltip>
        {:else if $page.data.user?.platform == "rover"}
            <Button class="text-white bg-blue-400 mt-4">Reminder</Button>
            <Tooltip 
                ...
                class="p-4 text-sm font-medium bg-blue-500 text-gray-100" 
                arrow={false}>
                You should track expenses such as Rover fees, refunds from cancellations, costs for pet supplies, legal or accounting fees, public transportation, vehicle-related expenses (mileage, maintenance, gas), and any costs associated with running their business from home to claim deductions for tax purposes.
            </Tooltip>
        {/if}
