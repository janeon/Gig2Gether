<script lang="ts">
    ...
    const xValues = {
      ...
      'Part/Full Time': ['Part-Time', 'Full-Time']
              ...
              // Would query data to get these averages in data Selections
          ...
          <Card>
            ...
            <div class="grid grid-cols-1 items-center border-gray-200 border-t dark:border-gray-700 justify-between">
              <div class="flex justify-center items-center pt-5">
                <h1 class="uppercase text-sm font-semibold hover:text-primary-700 dark:hover:text-primary-500 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 px-3 py-2 hover:no-underline class">
                  {yValueLabel}
                </h1>
              </div>
            </div>
