<script>
    ...
    const howItWorks = [
      { img: 'Registration.png', heading: 'User Registration', text: 'Create your GigUnity account by your phone number and complete a short demographics form to finalize registration.' },
